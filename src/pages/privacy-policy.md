...
- Other users know you by your creature, never by your username or display name. Your friends see your creature's name and number (for example, Blaze#0042), type, level, and challenger tier, along with your current streak and the date of your last workout. On each Gym Zone leaderboard, members of that zone see its top-ranked players, each with their rank, creature name (without the number), challenger tier, recent battle wins, and the score they are ranked by. In battle recaps, your opponent sees your creature (its type, evolution stage, and customized appearance) and which side won each compared stat and by roughly how much; someone who battles you sees your creature's name only if you are already friends or you appear on one of their Gym Zone leaderboards.
