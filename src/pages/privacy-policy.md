...
- Game activity. Creature state, battle history, season progress, cosmetic inventory, your friend connections, and the cheers you give on friends' activity feed items (which item and which emoji). We use this to run the game layer.
...
We use infrastructure and service providers to operate FitCreature. We require every third party that receives any data from us, including any analytics tools, advertising networks, and third-party SDKs we use, to provide the same or equal protection of user data as stated in this policy. Gym Zone names and the region search use public U.S. Census Bureau data stored in our own database; no service provider receives your location, area code, or the city or zip code you type.
...
- Friends can cheer an item in the activity feed with an emoji. Anyone who can see the item sees how many of each emoji it received, never who sent them. When you cheer an item, we store which item and which emoji, so you can take the cheer back; the cheer is deleted when the item leaves the feed or when your account is deleted.
...
- Your account, profile, game state (creature, battle stats, currency, cosmetics), friend connections (including any partner business locations you added, which also takes your creature off their members lists and member boards; see Section 5.3), push tokens, feedback, cheers you gave, and subscription and gift records are deleted from our active systems as part of the deletion request.
...
- The Gym Zones you were placed in stay in the game, with their area and name and no link to you (see Section 3.3).
